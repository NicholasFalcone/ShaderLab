    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        if (lightingType == 0)
        {
            ...
            if (sun.isActiveAndEnabled)
            {
                ...
                renderingMaterial.SetVector("_lightRotation", sun.transform.eulerAngles);
        ...
        else if (lightingType == 1 && sceneLight != null) // otherwise get the settings of the light the user has set
        {
            if (sceneLight.isActiveAndEnabled)
            {
                ...
                renderingMaterial.SetVector("_lightRotation", sceneLight.transform.eulerAngles);
        ...
        Texture2D GroundTexture = LoadTexture2D("DepthTexture");
        ...
        renderingMaterial.SetTexture("GroundTexture", GroundTexture);
