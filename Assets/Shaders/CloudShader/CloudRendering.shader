    ...
    Blend Off
        Pass
        {
            ...
            struct VertToFrag
            {
                ...
                float3 position_in_world_space : TEXCOORD2;
            };
            ...
            */
            ...
            float lightmarch(float3 pos, float heightPercentage)
            {
                ...
                float dotDir = dot(_lightRotation, dirVector);
                dirVector = dirVector * dotDir;
            ...
            fixed4 frag (VertToFrag i) : COLOR
            {
                ...
                rayContainerInfo containerInfo = getRayContainerInfo(rayOrigin, 1 + rayDir);
                
                rayContainerInfo containerInfo2 = getRayContainerInfo(_WorldSpaceCameraPos + float3(0,0,1) , rayDir);
                ...
                if(containerInfo.intersectedBox && containerInfo.dstInsideBox >= depth)
                {
                    /// Dissolve b * (1 - (d / cp))
                    return base * ((depth / containerInfo.dstInsideBox));
                } 
